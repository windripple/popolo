...
namespace Popolo.Utility
{
    class Program
    {
        ...
        private static void MakeBESTestResult()
        {
            Directory.CreateDirectory("BESTestResult");
            Console.WriteLine("C195");
            BESTest.Test(BESTest.TestCase.C195, "BESTestWeather.csv", "BESTestResult\\C195.csv");
            Console.WriteLine("C200");
            BESTest.Test(BESTest.TestCase.C200, "BESTestWeather.csv", "BESTestResult\\C200.csv");
            Console.WriteLine("C210");
            BESTest.Test(BESTest.TestCase.C210, "BESTestWeather.csv", "BESTestResult\\C210.csv");
            Console.WriteLine("C215");
            BESTest.Test(BESTest.TestCase.C215, "BESTestWeather.csv", "BESTestResult\\C215.csv");
            Console.WriteLine("C220");
            BESTest.Test(BESTest.TestCase.C220, "BESTestWeather.csv", "BESTestResult\\C220.csv");
            Console.WriteLine("C230");
            BESTest.Test(BESTest.TestCase.C230, "BESTestWeather.csv", "BESTestResult\\C230.csv");
            Console.WriteLine("C240");
            BESTest.Test(BESTest.TestCase.C240, "BESTestWeather.csv", "BESTestResult\\C240.csv");
            Console.WriteLine("C250");
            BESTest.Test(BESTest.TestCase.C250, "BESTestWeather.csv", "BESTestResult\\C250.csv");
            Console.WriteLine("C270");
            BESTest.Test(BESTest.TestCase.C270, "BESTestWeather.csv", "BESTestResult\\C270.csv");
            Console.WriteLine("C280");
            BESTest.Test(BESTest.TestCase.C280, "BESTestWeather.csv", "BESTestResult\\C280.csv");
            Console.WriteLine("C290");
            BESTest.Test(BESTest.TestCase.C290, "BESTestWeather.csv", "BESTestResult\\C290.csv");
            Console.WriteLine("C300");
            BESTest.Test(BESTest.TestCase.C300, "BESTestWeather.csv", "BESTestResult\\C300.csv");
            Console.WriteLine("C310");
            BESTest.Test(BESTest.TestCase.C310, "BESTestWeather.csv", "BESTestResult\\C310.csv");
            Console.WriteLine("C320");
            BESTest.Test(BESTest.TestCase.C320, "BESTestWeather.csv", "BESTestResult\\C320.csv");
            Console.WriteLine("C395");
            BESTest.Test(BESTest.TestCase.C395, "BESTestWeather.csv", "BESTestResult\\C395.csv");
            Console.WriteLine("C400");
            BESTest.Test(BESTest.TestCase.C400, "BESTestWeather.csv", "BESTestResult\\C400.csv");
            Console.WriteLine("C410");
            BESTest.Test(BESTest.TestCase.C410, "BESTestWeather.csv", "BESTestResult\\C410.csv");
            Console.WriteLine("C420");
            BESTest.Test(BESTest.TestCase.C420, "BESTestWeather.csv", "BESTestResult\\C420.csv");
            Console.WriteLine("C430");
            BESTest.Test(BESTest.TestCase.C430, "BESTestWeather.csv", "BESTestResult\\C430.csv");
            Console.WriteLine("C440");
            BESTest.Test(BESTest.TestCase.C440, "BESTestWeather.csv", "BESTestResult\\C440.csv");
            Console.WriteLine("C600");
            BESTest.Test(BESTest.TestCase.C600, "BESTestWeather.csv", "BESTestResult\\C600.csv");
            Console.WriteLine("C610");
            BESTest.Test(BESTest.TestCase.C610, "BESTestWeather.csv", "BESTestResult\\C610.csv");
            Console.WriteLine("C620");
            BESTest.Test(BESTest.TestCase.C620, "BESTestWeather.csv", "BESTestResult\\C620.csv");
            Console.WriteLine("C630");
            BESTest.Test(BESTest.TestCase.C630, "BESTestWeather.csv", "BESTestResult\\C630.csv");
            Console.WriteLine("C640");
            BESTest.Test(BESTest.TestCase.C640, "BESTestWeather.csv", "BESTestResult\\C640.csv");
            Console.WriteLine("C650");
            BESTest.Test(BESTest.TestCase.C650, "BESTestWeather.csv", "BESTestResult\\C650.csv");            
            Console.WriteLine("C800");
            BESTest.Test(BESTest.TestCase.C800, "BESTestWeather.csv", "BESTestResult\\C800.csv");
            Console.WriteLine("C810");
            BESTest.Test(BESTest.TestCase.C810, "BESTestWeather.csv", "BESTestResult\\C810.csv");
            Console.WriteLine("C900");
            BESTest.Test(BESTest.TestCase.C900, "BESTestWeather.csv", "BESTestResult\\C900.csv");
            Console.WriteLine("C910");
            BESTest.Test(BESTest.TestCase.C910, "BESTestWeather.csv", "BESTestResult\\C910.csv");
            Console.WriteLine("C920");
            BESTest.Test(BESTest.TestCase.C920, "BESTestWeather.csv", "BESTestResult\\C920.csv");
            Console.WriteLine("C930");
            BESTest.Test(BESTest.TestCase.C930, "BESTestWeather.csv", "BESTestResult\\C930.csv");
            Console.WriteLine("C940");
            BESTest.Test(BESTest.TestCase.C940, "BESTestWeather.csv", "BESTestResult\\C940.csv");
            Console.WriteLine("C950");
            BESTest.Test(BESTest.TestCase.C950, "BESTestWeather.csv", "BESTestResult\\C950.csv");
            Console.WriteLine("C600FF");
            BESTest.Test(BESTest.TestCase.C600FF, "BESTestWeather.csv", "BESTestResult\\C600FF.csv");
            Console.WriteLine("C650FF");
            BESTest.Test(BESTest.TestCase.C650FF, "BESTestWeather.csv", "BESTestResult\\C650FF.csv");
            Console.WriteLine("C900FF");
            BESTest.Test(BESTest.TestCase.C900FF, "BESTestWeather.csv", "BESTestResult\\C900FF.csv");
            Console.WriteLine("C950FF");
            BESTest.Test(BESTest.TestCase.C950FF, "BESTestWeather.csv", "BESTestResult\\C950FF.csv");
            Console.WriteLine("C960");
            BESTest.Test(BESTest.TestCase.C960, "BESTestWeather.csv", "BESTestResult\\C960.csv");
            Console.WriteLine("C990");
            BESTest.Test(BESTest.TestCase.C990, "BESTestWeather.csv", "BESTestResult\\C990.csv");
        }

        private static void MakeBESTResultExcelSheet()
        {
            const string folderName = "BESTestResult";
            string fileName = System.Environment.CurrentDirectory + "\\" + folderName + "\\BESTest検証.xls";
            ...
            {
                // ファイルオープン
                oWB = (Microsoft.Office.Interop.Excel._Workbook)(oXL.Workbooks.Open
                 (fileName,
                ...
                string[] fileNames = Directory.GetFiles(folderName,"*.csv");

                foreach (string fn in fileNames)
                {
                    Console.WriteLine("Converting " + fn);
                    using (StreamReader sReader = new StreamReader(fn))
                    {
                        sReader.ReadLine();
                        string sheetName = fn.Substring(fn.IndexOf('\\') + 1);
                        sheetName = sheetName.Remove(sheetName.Length - 4);
                        bool isC600 = (sheetName == "C600" || sheetName == "C610" || sheetName == "C620" || sheetName == "C630");
                        bool isC960 = (sheetName == "C960");
                        Excel._Worksheet ws = (Excel.Worksheet)oWB.Sheets[sheetName];

                        range = ws.get_Range("B2", System.Reflection.Missing.Value);
                        range = range.get_Resize(8760, 2);
                        double[,] saRet = new double[8760, 2];

                        double[,] saRet2 = null;

                        if (isC600)
                        {
                            saRet2 = new double[8760, 7];
                            range2 = ws.get_Range("I2", System.Reflection.Missing.Value);
                            range2 = range2.get_Resize(8760, 7);
                        }
                        else if (isC960)
                        {
                            saRet2 = new double[8760, 1];
                            range2 = ws.get_Range("I2", System.Reflection.Missing.Value);
                            range2 = range2.get_Resize(8760, 1);
                        }

                        string[] ss;
                        for (int i = 0; i < saRet.GetLength(0); i++)
                        {
                            ss = sReader.ReadLine().Split(',');
                            if (ss[6] != "-")
                            {
                                saRet[i, 0] = double.Parse(ss[6]);
                                saRet[i, 1] = double.Parse(ss[7]);
                            }

                            if (isC600)
                            {
                                saRet2[i, 0] = double.Parse(ss[1]);
                                saRet2[i, 1] = double.Parse(ss[2]);
                                saRet2[i, 2] = double.Parse(ss[3]);
                                saRet2[i, 3] = double.Parse(ss[4]);
                                saRet2[i, 4] = double.Parse(ss[5]);
                                saRet2[i, 5] = double.Parse(ss[8]);
                                saRet2[i, 6] = double.Parse(ss[9]);
                            }
                            else if (isC960)
                            {
                                saRet2[i, 0] = double.Parse(ss[10]);
                            }
                        }
                        range.set_Value(System.Reflection.Missing.Value, saRet);
                        if (isC600 || isC960) range2.set_Value(System.Reflection.Missing.Value, saRet2);
                    }
                    File.Delete(fn);
                }
            }
