...
namespace Popolo.ThermalLoad
{
    ...
    public class Wall : ImmutableWall
    {
        ...
        #region public methods//熱伝導計算関連の処理
        ...
        public void Update()
        {
            ...
            uxMatrix.VectorProduct(temperatures, ref cfVector, 1.0, 0.0);
            ...
            if (tubes.Count != 0)
            {
                ...
                uxMatrix.VectorProduct(fpt1, ref fpt2, 1.0, 0.0);
            }
        ...
        {
            updateTemperatures();
            double[] temp = new double[temperatures.Size];
            temperatures.CopyTo(ref temp);
            return temp;
        }
        ...
        #region public methods//モデル構築関連の処理
        ...
        public void FreezeState(ref double[] state)
        {
            cfVector.CopyTo(ref state);
        }
        ...
        {
            temperaturesFRZ.CopyFrom(state);
        }

        #endregion

        #region public methods//潜熱蓄熱材料設定関連の処理
        ...
        public void InitializeTemperature(double wallTemperature)
        {
            ...
            ux0mMatrix.VectorProduct(solAirTemp, ref cfVector, -1, 1.0);
        ...
        private void makeUXMatrix()
        {
            ...
            //逆行列の計算
            uMatrix2.GetInverse(ref uxMatrix);
        ...
        private void updateTemperatures()
        {
            ...
            ux0mMatrix.VectorProduct(solAirTemp, ref temperatures, 1.0, 1.0);
