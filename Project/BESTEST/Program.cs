...
namespace BESTEST
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Make CSV weather data from TMY data
            ReadAndWriteBESTestWeatherData("DRYCOLD.TMY", "BESTestWeather.csv");

            //Conduct a Test
            Directory.CreateDirectory("Result");
            Console.WriteLine("C195");
            Test(TestCase.C195, "BESTestWeather.csv", "Result\\C195.csv");
            Console.WriteLine("C200");
            Test(TestCase.C200, "BESTestWeather.csv", "Result\\C200.csv");
            Console.WriteLine("C210");
            Test(TestCase.C210, "BESTestWeather.csv", "Result\\C210.csv");
            Console.WriteLine("C215");
            Test(TestCase.C215, "BESTestWeather.csv", "Result\\C215.csv");
            Console.WriteLine("C220");
            Test(TestCase.C220, "BESTestWeather.csv", "Result\\C220.csv");
            Console.WriteLine("C230");
            Test(TestCase.C230, "BESTestWeather.csv", "Result\\C230.csv");
            Console.WriteLine("C240");
            Test(TestCase.C240, "BESTestWeather.csv", "Result\\C240.csv");
            Console.WriteLine("C250");
            Test(TestCase.C250, "BESTestWeather.csv", "Result\\C250.csv");
            Console.WriteLine("C270");
            Test(TestCase.C270, "BESTestWeather.csv", "Result\\C270.csv");
            Console.WriteLine("C280");
            Test(TestCase.C280, "BESTestWeather.csv", "Result\\C280.csv");
            Console.WriteLine("C290");
            Test(TestCase.C290, "BESTestWeather.csv", "Result\\C290.csv");
            Console.WriteLine("C300");
            Test(TestCase.C300, "BESTestWeather.csv", "Result\\C300.csv");
            Console.WriteLine("C310");
            Test(TestCase.C310, "BESTestWeather.csv", "Result\\C310.csv");
            Console.WriteLine("C320");
            Test(TestCase.C320, "BESTestWeather.csv", "Result\\C320.csv");
            Console.WriteLine("C395");
            Test(TestCase.C395, "BESTestWeather.csv", "Result\\C395.csv");
            Console.WriteLine("C400");
            Test(TestCase.C400, "BESTestWeather.csv", "Result\\C400.csv");
            Console.WriteLine("C410");
            Test(TestCase.C410, "BESTestWeather.csv", "Result\\C410.csv");
            Console.WriteLine("C420");
            Test(TestCase.C420, "BESTestWeather.csv", "Result\\C420.csv");
            Console.WriteLine("C430");
            Test(TestCase.C430, "BESTestWeather.csv", "Result\\C430.csv");
            Console.WriteLine("C440");
            Test(TestCase.C440, "BESTestWeather.csv", "Result\\C440.csv");
            Console.WriteLine("C600");
            Test(TestCase.C600, "BESTestWeather.csv", "Result\\C600.csv");
            Console.WriteLine("C610");
            Test(TestCase.C610, "BESTestWeather.csv", "Result\\C610.csv");
            Console.WriteLine("C620");
            Test(TestCase.C620, "BESTestWeather.csv", "Result\\C620.csv");
            Console.WriteLine("C630");
            Test(TestCase.C630, "BESTestWeather.csv", "Result\\C630.csv");
            Console.WriteLine("C640");
            Test(TestCase.C640, "BESTestWeather.csv", "Result\\C640.csv");
            Console.WriteLine("C650");
            Test(TestCase.C650, "BESTestWeather.csv", "Result\\C650.csv");
            Console.WriteLine("C800");
            Test(TestCase.C800, "BESTestWeather.csv", "Result\\C800.csv");
            Console.WriteLine("C810");
            Test(TestCase.C810, "BESTestWeather.csv", "Result\\C810.csv");
            Console.WriteLine("C900");
            Test(TestCase.C900, "BESTestWeather.csv", "Result\\C900.csv");
            Console.WriteLine("C910");
            Test(TestCase.C910, "BESTestWeather.csv", "Result\\C910.csv");
            Console.WriteLine("C920");
            Test(TestCase.C920, "BESTestWeather.csv", "Result\\C920.csv");
            Console.WriteLine("C930");
            Test(TestCase.C930, "BESTestWeather.csv", "Result\\C930.csv");
            Console.WriteLine("C940");
            Test(TestCase.C940, "BESTestWeather.csv", "Result\\C940.csv");
            Console.WriteLine("C950");
            Test(TestCase.C950, "BESTestWeather.csv", "Result\\C950.csv");
            Console.WriteLine("C600FF");
            Test(TestCase.C600FF, "BESTestWeather.csv", "Result\\C600FF.csv");
            Console.WriteLine("C650FF");
            Test(TestCase.C650FF, "BESTestWeather.csv", "Result\\C650FF.csv");
            Console.WriteLine("C900FF");
            Test(TestCase.C900FF, "BESTestWeather.csv", "Result\\C900FF.csv");
            Console.WriteLine("C950FF");
            Test(TestCase.C950FF, "BESTestWeather.csv", "Result\\C950FF.csv");
            Console.WriteLine("C960");
            Test(TestCase.C960, "BESTestWeather.csv", "Result\\C960.csv");
            Console.WriteLine("C990");
            Test(TestCase.C990, "BESTestWeather.csv", "Result\\C990.csv");

            //Convert the result of the simulation
        ...
        #region Making wall compositions
        ...
        #region Converting weather data
        ...
        #region Converting result

        private static void MakeBESTResultExcelSheet()
        {
            const string folderName = "Result";
            string fileName = System.Environment.CurrentDirectory + "\\" + folderName + "\\Result.xls";
